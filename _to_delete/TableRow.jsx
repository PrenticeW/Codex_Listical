...
const TableRow = React.memo(function TableRow({
  ...
  // Alternate the archive week (green divider) row colour: even display
  // positions get the base green, odd ones a slightly darker shade.
  const archiveWeekStyle = isArchiveWeekRow
    ? ((row.original._archiveAltIndex ?? 0) % 2 === 1 ? ARCHIVE_ROW_ALT_STYLE : ARCHIVE_ROW_STYLE)
    : null;
      ...
      {isFixedRegionBlackRow && (
        ...
        <div
          ...
          style={{
            ...
            backgroundColor: isFilterRow ? 'var(--th-section)' : 'black',
          ...
          return row.getVisibleCells().map(cell => {
            ...
            if (isArchiveWeekRow && ['task', 'recurring', 'estimate', 'timeValue'].includes(columnId)) {
              ...
              if (columnId === 'task') {
                ...
                // Weekly total (the figure next to the "of X.XX - X.XX"
                // min/max cell) reads bold so it stands out as the headline
                // number of the archived week.
              ...
              >
                ...
                {hasFilter && filterClickHandler && (
                  <FilterIcon
                    ...
                    inactiveColor="var(--th-gutter-text)"
