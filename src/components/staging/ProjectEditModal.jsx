 ...
 * @param {Object} props.planModal - Modal state with color, projectNickname
...
export default function ProjectEditModal({
  ...
  const MENU_HEIGHT = 340; // generous estimate
  const MARGIN = 16;
  ...
  return createPortal(
    <>
      {/* Invisible backdrop — click outside the menu to save & close */}
      <div
