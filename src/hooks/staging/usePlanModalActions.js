...
import { clonePlanTableEntries, cloneStagingState } from '../../utils/staging/planTableHelpers';
import { ensurePlanPairingMetadata } from '../../utils/staging/rowPairing';

/**
 * Hook to handle plan modal actions (save, close)
 */
export default function usePlanModalActions({ planModal, setState, closePlanModal, executeCommand }) {
  /**
  ...
  const handlePlanNext = useCallback(() => {
    ...
    closePlanModal();
  }, [planModal, setState, closePlanModal, executeCommand]);
